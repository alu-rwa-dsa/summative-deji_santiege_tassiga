...
"""This class hold our chess board surface, and the pawn. We also define some specific 
functions for our board surface
surface."""
...
#Space complexity  of the code is big O(1)
            ...
            for j in range(self.cols):
                if self.board[i][j] != 0:
                    if self.board[i][j].king and self.board[i][j].color == color:
                        king_pos = (j, i)
#  Time complexity of this function is O(n2).....Quadratic runtime complexity
 # The Algoorithm Varies with the square of the problem size ,n.
 # Space complexity O(1)...color takes a constant space which is not iterable
 #  It is also called Linear space comlexity
        ...
        for i in range(self.rows):
            for j in range(self.cols):
                if self.board[i][j] != 0:
                    ...
                    #The algorithm varies with the square of the problem size, n.
                    # Space complexity O(1)...color takes a constant space which is not iterable
                    #  It is also called Linear space complexity
